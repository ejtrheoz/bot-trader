...
def hash_ribbons():
    df = pd.read_csv("https://data.nasdaq.com/api/v3/datasets/BCHAIN/HRATE.csv?api_key=_ceSKrfy_fUJnxHD3DN9")
    hash_values = []
    hash_dates = []
...
def btc_volatility():
    ...
    df = pd.read_csv("https://query1.finance.yahoo.com/v7/finance/download/BTC-USD?period1=1637071376&period2="+end_date+"&interval=1d&events=history&includeAdjustedClose=true")
